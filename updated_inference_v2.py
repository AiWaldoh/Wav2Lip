...
def main():
    full_frames, fps = load_frames()

    wav = audio.load_wav(args.audio, 16000)
    mel = audio.melspectrogram(wav)
    print(mel.shape)

    mel_chunks = get_mel_chunks(fps, mel)
    ...
    out = get_out(full_frames, fps, mel_chunks, batch_size, gen)
...
def get_out(full_frames, fps, mel_chunks, batch_size, gen):
